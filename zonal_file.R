...
input_folder  <- "C:/A_TRABAJO/DATA/CHELSA/CLIMATOLOGIAS_IBERIA"
output_folder <- "C:/A_TRABAJO/ALEJANDRA/1km/climate3"
...
input_folder  <- "D:/A_DATA/MDT/EUROPE"
output_folder <- "C:/A_TRABAJO/ALEJANDRA/10km/topography2"
